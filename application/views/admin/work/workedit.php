...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#btnview").click(function(){
            var win = window.open("<?php echo base_url("works/".$dbarticle->get_id()."/".$dbarticle->url_slug); ?>", '_blank');
            win.focus();
        });
        ...
        $("#btndelete").click(function(){
            var c = confirm("Are you sure you want to delete this work article?");
            if(c==true){
                $(this).hide();
                $.post("<?php echo base_url("myadmin/works/delete/".$dbarticle->get_id()); ?>",function(data){
                    if(data.success==true){
                        window.location.href="<?php echo base_url("myadmin/works/index"); ?>";
                    }
                    else{
                        $("#alerterror").html("Unable to delete work article.");
                    }
                },"json");
            }
        });
