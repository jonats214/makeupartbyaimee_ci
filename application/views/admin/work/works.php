...
?>
<?php $succmsg = $this->session->flashdata( 'works_success' );
$warningmsg = $this->session->flashdata( 'works_warning' );
if(strlen($succmsg)>0): ?>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="pull-right">
            <button type="button" class="btn btn-primary" id="btnaddarticle" name="btnaddarticle">Create New Work Article</button>
        </div>
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit Work Article" onclick="jQuery(function($){window.location.href='<?php echo base_url("myadmin/works/edit/".$row["id"]); ?>';})">
...
$(document).ready(function(){
    $('#btnaddarticle').click(function(){
        window.location.href="<?php echo base_url("myadmin/works/add"); ?>";
    });
});
</script>
